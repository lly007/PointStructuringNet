...
from models.pointnet_util_psn import PointNetSetAbstraction,PointNetFeaturePropagation
...
class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=512, radius=0.2, nsample=64, in_channel=6+additional_channel, mlp=[64, 64, 128], group_all=False)  # 这里修改过   nsample原来是32
